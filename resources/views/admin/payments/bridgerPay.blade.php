...
<div class="page-container">
    ...
    <div class="page-content-wrapper">
		<div class="page-content">
			...
			<!-- END PAGE HEADER-->
			<!-- BEGIN PAGE CONTENT-->
			<h3 class="page-title">BridgerPay Gateway Settings</h3>
			<div class="row" style="display: flex; justify-content: center;">
				<div class="col-md-8">
					<div class="portlet box yellow-crusta">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-gift"></i>BridgerPay Configuration
							</div>
							<div class="tools">
						...
						<div class="portlet-body form">
							<div id="form-username" class="form-horizontal form-bordered">
								<div class="form-group">
									...
									<div class="col-sm-4">
										<input type="checkbox" {{$bridgerPay_real_switch?'checked':''}} class="make-switch" data-on-text="&nbsp;Enabled&nbsp;&nbsp;" data-off-text="&nbsp;Disabled&nbsp;" id="bridgerPay_real_switch">
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-3 control-label">Live/Test</label>
									<div class="col-sm-4">
										<input type="checkbox"  {{$bridgerPay_switch=="live"?'checked':''}}  class="make-switch" data-on-text="&nbsp;Live&nbsp;&nbsp;" data-off-text="&nbsp;Test&nbsp;" id="bridgerPay_switch">
									</div>
								</div>
                                <div class="form-group">
									...
									<div class="col-sm-4">
										<div class="input-group">
											...
											<input type="text" id="api_key" name="typeahead_example_3" class="form-control" value="{{$apiKey}}" />
										</div>
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-3 control-label">CASHIER KEY</label>
									<div class="col-sm-4">
										<div class="input-group">
											<span class="input-group-addon">
												<i class="fa fa-cogs"></i>
											</span>
											<input type="text" id="cashier_key" name="typeahead_example_3" class="form-control" placeholder="{{ substr($cashierKey, 0, 5) . '*****'}}"/>
										</div>
									</div>
								</div>
								...
								<div class="form-actions">
									<div class="row">
										<div class="col-md-offset-3 col-md-9">
											<button type="submit" class="btn purple" onclick="updatebridgerPay()"><i class="fa fa-check"></i>Save</button>
