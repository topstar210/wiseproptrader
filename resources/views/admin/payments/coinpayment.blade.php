...
<div class="page-container">
    ...
    <div class="page-content-wrapper">
        <div class="page-content">
            ...
            <!-- END PAGE HEADER-->
            <!-- BEGIN PAGE CONTENT-->
            <h3 class="page-title">Coinpayment Gateway Settings</h3>
            <div class="row" style="display: flex; justify-content: center;">
                <div class="col-md-8">
                    <div class="portlet box purple">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-gift"></i>CoinPayment Configuration
                            </div>
                            <div class="tools">
                        ...
                        <div class="portlet-body form">
                            <div id="form-username" class="form-horizontal form-bordered">
								<div class="form-group">
									...
									<div class="col-sm-4">
										<input type="checkbox" {{$coinpayment_real_switch?'checked':''}} class="make-switch" data-on-text="&nbsp;Enabled&nbsp;&nbsp;" data-off-text="&nbsp;Disabled&nbsp;" id="coinpayment_real_switch">
									</div>
								</div>
                                <div class="form-group">
                                ...
                                <div class="form-actions">
                                    <div class="row">
                                        <div class="col-md-offset-3 col-md-9">
                                            <button type="submit" class="btn purple" onclick="updateCoinSetting()"><i class="fa fa-check"></i>Save</button>
