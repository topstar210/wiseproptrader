...
<header>
					...
					<ul class="crypt-heading-menu fright">
						...
						<li style="margin-left: 20px">
							<form id="logout-form" action="{{ route('logout') }}" method="POST">
								@csrf
						<li class="crypt-box-menu menu-red"><a href="#" onclick="OnLogOut()">{{ __('Logout') }}</a></li>
						</form>
						</li>
					</ul>
	...
	<div class="crypt-mobile-menu">
		<ul class="crypt-heading-menu">
			@if(!$verify)
				<li><a class="crypt-box-menu menu-green" style="margin-right: 50px; height: 35px;" onclick="verifyID()">Verify ID</a></li>
			@endif
			<li><a href="{{ route('home') }}">Dashboard</a></li>
			<li><a href="{{ route('profile') }}">Profile</a></li>
			@if($is_admin)
...
<div class="container-fluid-width pt-4 d-flex flex-wrap profile-main-row">
 ...
 @endif
	...
	<div class="col-lg-3 col-md-4 col-12 px-1 pl-3">
		<div class="profile-left">
			<div class="user-info">
				<span class="user-avtar"><i class="far fa-user"></i></span>
				<h5>{{$data['name']}}</h5>
			</div>
				...
				<ul class="nav nav-tabs flex-column" role="tablist">
					...
					<!-- <li class="nav-item">
						<a class="nav-link d-flex align-items-center justify-content-between" data-toggle="tab" href="#communication">
							<span><i class="far fa-bell pr-2"></i> Communication Center</span>
							<i class="bi bi-chevron-right"></i>
						</a>
					</li> -->
					<li class="nav-item">
	...
	<div class="col-lg-9 col-md-8 col-12 px-1 pr-3">
		<div class="profile-right">
			<div class="tab-content text-white">
				<div id="deposits" class="container tab-pane active"><br>
					<div class="pending-funds crypt-dark p-4">
						<h2 class="mb-3" id="sectionTitle">Deposit</h2>
						<div class="">
							<div class="crypt-dash-withdraw mt-3 d-block" id="bitcoin">
								<div class="crypt-withdraw-heading">
									<div class="row">
										...
										<div class="col-8" id="quickDepositButtons">
								...
								<div class="crypt-withdraw-body bg-white">
									<div class="row">
										<div class="col-md-3">
											<div class="nav flex-column nav-pills" role="tablist" aria-orientation="vertical" id="depositWithdrayTabs">
												...
												<a class="nav-link" id="v-pills-zi lliqua-btc-withdrawl-tab" data-toggle="pill" href="#v-pills-zilliqua-btc-withdrawl" role="tab" aria-controls="v-pills-zilliqua-btc-withdrawl" aria-selected="false"><i class="pe-7s-up-arrow"></i>Withdraw</a>
										...
										<div class="col-md-9">
											<div class="tab-content" id="v-pills-zilliqua-btc-tabContent">
												<div class="tab-pane fade show active" id="v-pills-zilliqua-btc-deposit" role="tabpanel" aria-labelledby="v-pills-zilliqua-btc-deposit-tab">
												    @if($isClient)
												    <a href="https://wiseproptrader.com/">
												    <button type="button" class="btn btn-success" style="background: #5ce0e5;color:#000">More Funding</button>
												    </a>
												    @else
													<div class="flex">
													    <div class="cardbtn">
													        <input type="hidden" name="amount" value="0">
													        <h3 style="color: #000; padding: 12px;margin-top: 8px;">$1000</h3>
													    </div>
													    <div class="cardbtn">
													        <input type="hidden" name="amount" value="49">
													        <h3 style="color: #000; padding: 12px;margin-top: 8px;">$2500</h3>
													    </div>
													    <div class="cardbtn">
													        <input type="hidden" name="amount" value="79">
													        <h3 style="color: #000; padding: 12px;margin-top: 8px;">$5000</h3>
													    </div>
													    <div class="cardbtn">
													        <input type="hidden" name="amount" value="149">
													        <h3 style="color: #000; padding: 12px;margin-top: 8px;">$10000</h3>
													    </div>
													    <div class="cardbtn">
													        <input type="hidden" name="amount" value="249">
													        <h3 style="color: #000; padding: 12px;margin-top: 8px;">$25000</h3>
													    </div>
													</div>
													@endif
												</div>
												<div class="tab-pane fade" id="v-pills-zilliqua-btc-withdrawl" role="tabpanel" aria-labelledby="v-pills-zilliqua-btc-withdrawl-tab">
													...
													<form>
														...
														<p class="crypt-button-red-full"> 10% profits in 30 days You can withdraw. You may only withdraw 50% of the profits you make in 30 days. </p>
														@else
														<a href="#" class="crypt-button-red-full" onclick="withdrawPayment()">Initiate Withdraw</a>
														@endif
													</form>
												</div>
				...
				<div id="tradeStatements" class="container tab-pane fade">
					...
					<div class="row">
						<div class="col-md-8">
							{{ html()->modelForm('', 'GET', '/' . Route::current()->uri.'#tradeStatementsTab')->class('form-inline')->open() }}
